...
{
    [TestFixture]
    public class HS040ManagedTests
    {
        #region Unit tests
        ...
        {
            var instance = new HS040(false, true, false);
        ...
        {
            var instance = new HS040(false, true, true);
            var x = new[] { 0.8, 0.8, 0.8, 0.8 };
        ...
        public void SolveProblem_ExactHessian_NumberOfIterationsLessThanOrEqualToHessianApprox()
        {
            ...
            var approx = new HS040(false, true, true);
            var x = new[] { 0.8, 0.8, 0.8, 0.8 };
            double obj;
            ...
            var exact = new HS040(false, false, true);

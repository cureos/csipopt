...
NOTE! Following recent changes in the signatures of the native callback functions, the Mono
runtime fails when calling the native callback function implementations. However, the gmcs
compiler appears to compile the csipopt code correctly, and gmcs compiled code can be 
successfully executed by the regular .NET runtime.


== Revision

Last updated on December 18, 2011 by Anders Gustafsson, anders[at]cureos[dot]com, http://www.cureos.com.
